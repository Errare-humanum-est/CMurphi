/**CHeaderFile*****************************************************************
  ...
  Synopsis    [Header file for declarations]
...
Union,
  ...
  const char *structurestring() const {
    ...
    case NoScalarset:
      return "NoScalarset";
      case ScalarsetVariable:return "ScalarsetVariable";
      case ScalarsetArrayOfFree:return "ScalarsetArrayOfFree";
      case ScalarsetArrayOfScalarset:return "ScalarsetArrayOfScalarset";
